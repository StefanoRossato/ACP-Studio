...
-- ACP Studio
--
-- Test         : GUI-205 Home Component Composition Test
-- File         : Tests/GUI/GUI-205 Home Component Composition Test.lua
--
-- Purpose
-- -------
-- Certifies the Home View component composition.
--
-- Certification
-- -------------
...
reaper.ShowConsoleMsg(
"Home Component Composition Test\n"
)
...
local function Main()
    ...
    if visible then
        ...
        if not Certified then
            ...
            reaper.ShowConsoleMsg(
            "PASS - HomeHeader rendered\n"
            )

            reaper.ShowConsoleMsg(
            "PASS - HomeWelcome rendered\n"
            )

            reaper.ShowConsoleMsg(
            "PASS - HomeDashboard rendered\n"
            )

            reaper.ShowConsoleMsg(
            "PASS - HomeWorkspace rendered\n"
            )

            reaper.ShowConsoleMsg(
            "PASS - Home component composition verified\n"
            )
